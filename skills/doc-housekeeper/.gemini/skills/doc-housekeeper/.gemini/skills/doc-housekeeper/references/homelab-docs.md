...
5. **Registry Extraction & Verification**: Any factual data regarding "known states" (Hardware models, IPs, Software versions) found in secondary docs (e.g. Design drafts, logs) must be migrated to the `registry/`.
